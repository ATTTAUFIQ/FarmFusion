...
const Register: React.FC = () => {
  ...
  return (
    <section className="bg-gray-100 min-h-screen flex box-border justify-center items-center">
      <div className="bg-[#2cd156] rounded-2xl flex max-w-3xl p-5 items-center">
        ...
        <div className="md:w-1/2 px-8">
          ...
          <p className="text-sm mt-4 text-white">
            If you are not a member register as farmer.
          </p>
        ...
        <div className="mt-10 text-sm border-b border-gray-500 py-5 playfair tooltip">
          ...
          <div className="mt-4 text-sm flex justify-between items-center container-mr">
            ...
            <Link to={'/login'} className="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">
              Login
            </Link>
          </div>
        </div>
